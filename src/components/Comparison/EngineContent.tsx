...
const RendimientoCard = () => {
  ...
  return (
    <View style={styles.container}>
        <Text style={styles.title}>Tipo de Consumo</Text>

      {/* Card para Tipo de consumo */}
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Nivel de consumo </Text>
        <Text style={styles.description}>Consumo de combustible del vehículo.</Text>
        <View style={styles.chartContainer}>
          <View style={styles.row}>
            <Text style={styles.bullet}>{'\u2022'}</Text>
            <Text style={[styles.barLabel, { color: 'purple' }]}>{autos[0].tipo_consumo.descripcion}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.bullet}>{'\u2022'}</Text>
            <Text style={[styles.barLabel, { color: 'red' }]}>{autos[1].tipo_consumo.descripcion}</Text>
          </View>
        </View>
        {/* <TouchableOpacity
