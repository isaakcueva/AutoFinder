...
<View style={styles.card}>
  <Text style={styles.cardTitle}>Sistema de Airbags</Text>
  <Text style={styles.description}>Incluye información sobre los airbags del vehículo.</Text>
  <View style={styles.chartContainer}>
    <View style={styles.row}>
      <Text style={styles.bullet}>{'\u2022'}</Text>
      <Text style={[styles.barLabel, { color: 'purple' }]}>{autos[0].seguridad.airbag.incluye}</Text>
    </View>
    <View style={styles.row}>
      <Text style={styles.bullet}>{'\u2022'}</Text>
      <Text style={[styles.barLabel, { color: 'red' }]}>{autos[1].seguridad.airbag.incluye}</Text>
    </View>
  </View>
  <TouchableOpacity
    ...
    onPress={() =>
      showDetail(
        'Detalles del Sistema de Airbags',
        autos[0].seguridad.airbag.detalle || 'Sin detalles',
        autos[1].seguridad.airbag.detalle || 'Sin detalles'
      )
    }
  >
...
{/* Card para Frenos */}
<View style={styles.card}>
    <Text style={styles.cardTitle}>Sistema de Frenos</Text>
    <Text style={styles.description}>Tipo de frenos con el que cuenta el vehículo.</Text>
    <View style={styles.chartContainer}>
        <View style={styles.row}>
        <Text style={styles.bullet}>{'\u2022'}</Text>
        <Text style={[styles.barLabel, { color: 'purple' }]}>{autos[0].seguridad.frenos.tipo}</Text>
        </View>
        <View style={styles.row}>
        <Text style={styles.bullet}>{'\u2022'}</Text>
        <Text style={[styles.barLabel, { color: 'red' }]}>{autos[1].seguridad.frenos.tipo}</Text>
        </View>
    </View>
    <TouchableOpacity
        style={styles.moreDetailsButton}
        ...
        showDetail(
            ...
            autos[0].seguridad.frenos.detalle || 'Sin detalles',
            autos[1].seguridad.frenos.detalle || 'Sin detalles'
        )
        }
    >
        <Text style={styles.moreDetailsText}>Ver más detalles</Text>
...
{/* Card para Cinturones */}
<View style={styles.card}>
    <Text style={styles.cardTitle}>Cinturones de Seguridad</Text>
    <Text style={styles.description}>Incluye información sobre los cinturones de seguridad del vehículo.</Text>
    <View style={styles.chartContainer}>
        <View style={styles.row}>
        <Text style={styles.bullet}>{'\u2022'}</Text>
        <Text style={[styles.barLabel, { color: 'purple' }]}>{autos[0].seguridad.cinturones.incluye}</Text>
        </View>
        <View style={styles.row}>
        <Text style={styles.bullet}>{'\u2022'}</Text>
        <Text style={[styles.barLabel, { color: 'red' }]}>{autos[1].seguridad.cinturones.incluye}</Text>
        </View>
    </View>
    <TouchableOpacity
        style={styles.moreDetailsButton}
        onPress={() =>
        showDetail(
            'Detalles de los Cinturones de Seguridad',
            autos[0].seguridad.cinturones.detalle || 'Sin detalles',
            autos[1].seguridad.cinturones.detalle || 'Sin detalles'
        )
        }
    >
        <Text style={styles.moreDetailsText}>Ver más detalles</Text>
